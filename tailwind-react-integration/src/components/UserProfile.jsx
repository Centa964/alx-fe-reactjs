function UserProfile() {
    return (
      <div className="hover:shadow-xl user-profile bg-gray-100 sm:p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg">
        <img className="hover:scale-110 transition-transform duration-300 ease-in-out rounded-full sm:h-24 sm:w-24 md:h-36 md:w-36 mx-auto" src="https://via.placeholder.com/150" alt="User" />
